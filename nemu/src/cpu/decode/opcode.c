...
instr_func opcode_entry[256] = {
    ...
    /* 0x8c - 0x8f*/ inv, lea, mov_rm2sreg_w, pop_rm_v,
    ...
    /* 0xc0 - 0xc3*/ group_2_b, group_2_v, ret_i, ret,
    ...
    /* 0xe8 - 0xeb*/ call, jmp_near, ljmp, jmp_short,
...
instr_func group_5_indirect_entry[8] =
    {inc_rm_v, dec_rm_v, call_rm_v, inv, jmp_rm_v, inv, push_rm_v, inv};

instr_func group_7_entry[8] =
    {inv, inv, lgdt_rm_v, inv, inv, inv, inv, inv};
