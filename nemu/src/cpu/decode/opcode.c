...
instr_func opcode_entry[256] = {
    ...
    /* 0x8c - 0x8f*/ inv, lea, inv, pop_rm_v,
    ...
    /* 0xc0 - 0xc3*/ group_2_b, group_2_v, inv, ret,
    ...
    /* 0xe8 - 0xeb*/ call, jmp_near, inv, jmp_short,
    ...
    /* 0xfc - 0xff*/ cld, inv, inc_rm_b, group_5_indirect,
};

/* 0x80 */
instr_func group_1_b_entry[8] =
    {add_i2rm_b, inv, adc_i2rm_b, inv, and_i2rm_b, sub_i2rm_b, xor_i2rm_b, cmp_i2rm_b};

/* 0x81 */
instr_func group_1_v_entry[8] =
    {add_i2rm_v, inv, adc_i2rm_v, inv, and_i2rm_v, sub_i2rm_v, xor_i2rm_v, cmp_i2rm_v};

/* 0x83 */
instr_func group_1_bv_entry[8] =
    {add_i2rm_bv, inv, adc_i2rm_bv, inv, and_i2rm_bv, sub_i2rm_bv, xor_i2rm_bv, cmp_i2rm_bv};
